 ...
 * interface.
 */
public class DefenceFragment extends Fragment implements AbsListView.OnItemClickListener {
    ...
    // TODO: Rename and change types of parameters
    public static DefenceFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_defence, container, false);
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if (e == null) {
                    if(objects.size()>0) {
                        ...
                        query1.findInBackground(new FindCallback<ParseObject>() {
                            ...
                            public void done(List<ParseObject> person, ParseException e) {
                                if(person.size()==1){
                                    ...
                                    mAdapter = new DefenceAdapter(getActivity().getApplicationContext(),
                        ...
                        empty.setText("Looks like everyone loves you, cause no one has attacked you.\nYet.\nClick the rivals tab to wreck them first! ;)");
                    }
                }
                else{
                    //something wrong
    ...
    public class DefenceAdapter extends ArrayAdapter<ParseObject> {
        private int mResource;
        private ArrayList<ParseObject> mAttacks;
        private ArrayList<String> mFavs;

        public DefenceAdapter(Context context, int resource, ArrayList<ParseObject> attacks, ArrayList<String> favs){
        ...
        public View getView(int position, View row, ViewGroup parent){
            ...
            userTv.setText(attack.getString("fromUser"));
            swordButt.setVisibility(View.GONE);
            shieldButt.setVisibility(View.VISIBLE);
            shieldButt.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent attackIntent = new Intent(getActivity(), WarLogActivity.class);
                    attackIntent.putExtra("USERNAME", attack.getString("fromUser"));
